...
def process_cat_text():
    ...
    pos_sent = open(pos_file, 'r',encoding='utf-8').readlines()
    neg_sent = open(neg_file, 'r',encoding='utf-8').readlines()
    ...
    f_pos_train = open('dataset/{}{}_cat1.txt'.format(dataset, seq_len), 'w',encoding='utf-8')
    f_neg_train = open('dataset/{}{}_cat0.txt'.format(dataset, seq_len), 'w',encoding='utf-8')
    f_pos_test = open('dataset/testdata/{}{}_cat1_test.txt'.format(dataset, seq_len), 'w',encoding='utf-8')
    f_neg_test = open('dataset/testdata/{}{}_cat0_test.txt'.format(dataset, seq_len), 'w',encoding='utf-8')
    ...
    with open('dataset/testdata/{}{}_test.txt'.format(dataset, seq_len), 'w',encoding='utf-8') as fout:
        for sent in all_sent_test:
            fout.write(sent)
    with open('dataset/{}{}.txt'.format(dataset, seq_len), 'w',encoding='utf-8') as fout:
...
def combine_amazon_text():
    ...
    cat1_name = 'book'
    root_path = 'dataset/'
    cat0_train = open(root_path + cat0_name + '.txt', 'r',encoding='utf-8').readlines()
    cat0_test = open(root_path + cat0_name + '_test.txt', 'r',encoding='utf-8').readlines()
    cat1_train = open(root_path + cat1_name + '.txt', 'r',encoding='utf-8').readlines()
    cat1_test = open(root_path + cat1_name + '_test.txt', 'r',encoding='utf-8').readlines()

    with open(root_path + 'amazon_{}_{}.txt'.format(cat0_name, cat1_name), 'w',encoding='utf-8') as fout:
        for sent in cat0_train:
            fout.write(sent)
        for sent in cat1_train:
            fout.write(sent)
    with open(root_path + 'testdata/amazon_{}_{}_test.txt'.format(cat0_name, cat1_name), 'w',encoding='utf-8') as fout:
...
def extend_clas_train_data():
    ...
    neg_filter = open(neg_filter_file, 'r',encoding='utf-8').readlines()
    pos_filter = open(pos_filter_file, 'r',encoding='utf-8').readlines()
    neg_test = open(neg_test_file, 'r',encoding='utf-8').readlines()
    pos_test = open(pos_test_file, 'r',encoding='utf-8').readlines()
    neg_all = open(neg_all_file, 'r',encoding='utf-8').readlines()
    pos_all = open(pos_all_file, 'r',encoding='utf-8').readlines()
    ...
    with open('dataset/testdata/{}_cat0_clas_test.txt'.format(dataset), 'w',encoding='utf-8') as fout:
        for line in neg_test:
            fout.write(line)
    with open('dataset/testdata/{}_cat1_clas_test.txt'.format(dataset), 'w',encoding='utf-8') as fout:
        for line in pos_test:
            fout.write(line)
    with open('dataset/testdata/{}_clas_test.txt'.format(dataset), 'w',encoding='utf-8') as fout:
        for line in neg_test:
            fout.write(line)
        for line in pos_test:
            fout.write(line)
